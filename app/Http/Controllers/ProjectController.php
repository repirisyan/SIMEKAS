...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return to_route('project.index')->with('message', ['success', 'Data berhasil disimpan']);
        } catch (Exception $e) {
            return to_route('project.index')->with('message', ['success', 'Terjadi kesalahan saat menyimpan data']);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return to_route('project.index')->with('message', ['success', 'Data berhasil diubah']);
        } catch (Exception $e) {
            return to_route('project.index')->with('message', ['success', 'Terjadi kesalahan saat mengubah data']);
        }
    }
    ...
    public function destroy($id)
    {
        try {
            ...
            return to_route('project.index')->with('message', ['success', 'Data berhasil dihapus']);
        } catch (Exception $e) {
            return to_route('project.index')->with('message', ['success', 'Terjadi kesalahan saat menghapus data']);
        }
    }
}
